      ...
      <div class="extra__main__container">
        <div class="extra__main__content">
          <h1 class="extra__header__main extra__header__store__main">
            <span class="orange"></span> Недвижимость
          </h1>
			<?php
$main_descr = get_field('main-descr');
if ($main_descr) {
?>
          <p class="extra__header__descr extra__header__realEstate__descr">
    ...
    <div class="extra__container">
      <section class="extra__grade">
        <h2 class="extra__grade__header">
          Проверку в сфере недвижимости стоит проводить в следующих
          <span class="orange">ЦЕЛЯХ</span>
        </h2>
          ...
          <p class="extra__mysteryShopping__task__item">
            ...
            Проверка соблюдения корпоративных стандартов обслуживания
          </p>
          <p class="extra__mysteryShopping__task__item">
            <span class="extra__mysteryShopping__task__figure orange">02</span>
            Определение ошибок менеджеров по продажам в общении с клиентами
          </p>
          <p class="extra__mysteryShopping__task__item">
            <span class="extra__mysteryShopping__task__figure orange">03</span>
            Выяснение, предлагают ли сотрудники различные варианты жилья
          </p>
          <p class="extra__mysteryShopping__task__item">
            <span class="extra__mysteryShopping__task__figure orange">04</span>
            Оценка техники продаж сотрудников
          </p>
          <p class="extra__mysteryShopping__task__item">
            <span class="extra__mysteryShopping__task__figure orange">05</span>
            Выяснение, собирают ли менеджеры контактную информацию потенциальных
            клиентов для продолжения коммуникации
          </p>
          <p class="extra__mysteryShopping__task__item">
            <span class="extra__mysteryShopping__task__figure orange">06</span>
            Выяснение, придерживаются ли сотрудники корпоративных стандартов
            общения по телефону
          </p>
          <p class="extra__mysteryShopping__task__item">
            <span class="extra__mysteryShopping__task__figure orange">07</span>
            Опросы сотрудников для измерения уровня удовлетворенности работой и
            вовлеченности в корпоративную культуру
          </p>
          <p class="extra__mysteryShopping__task__item">
            <span class="extra__mysteryShopping__task__figure orange">08</span>
            Оценка работы управляющей компании и эксплуатационной службы,
            соблюдения технико-строительных нормативных актов
          </p>
          <p class="extra__mysteryShopping__task__item">
            <span class="extra__mysteryShopping__task__figure orange">09</span>
            Исследование интерфейса сайта и приложений, удобства работы,
            понятности навигации и пр.
          </p>
          <p class="extra__mysteryShopping__task__item">
            <span class="extra__mysteryShopping__task__figure orange">10</span>
            Проведение мониторинга конкурентов, включая анализ особенностей
            сервиса, условий покупки, бонусных программ и дополнительных услуг
          </p>
          <p class="extra__mysteryShopping__task__item">
            <span class="extra__mysteryShopping__task__figure orange">11</span>
            Проведение опроса удовлетворенности и лояльности клиентов на
            различных этапах взаимодействия с компанией, например, на этапе
            переговоров, передачи ключей или после года проживания
          </p>
  </div>
				 
				 	 <div class="extra__grade__right extra__mysteryShopping__right">
                    <picture>
                        <source srcset="https://brandmetrika.ru/wp-content/uploads/2023/09/real-estate@2x.png">
                        <img class="picture__img extra__grade__img extra__realEstate-img" 
                        src="https://brandmetrika.ru/wp-content/uploads/2023/09/real-estate@2x.png" alt="real-estate">
                      </picture>
                </div>
          ...
          <div class="extra__black__container mt48 telecom-black-container">
            <p class="extra__grade__descr extra__medical__descr white-text telecom-descr-down">
              Кроме перечисленных методов, для сферы недвижимости применимы и
              другие исследовательские методы, такие как анализ рыночных
              трендов, проведение фокус групп, аудит бренда и многое другое.
            </p>
          </div>
...
if ($descr_down) {
    foreach ($descr_down as $descr_down_item) {
        ...
        ?>
        <p class="extra__grade__descr extra__medical__descr extra__realEstate__descr-down">
           <?php echo $descr_1; ?>	
        </p>
		  <?php
    }
