...
?>
       ...
       <main>
        <div class="extra__img__container__main extra__img__reseachBrand__container__main">
        <div class="extra__main__container">
            <div class="extra__main__content">
                <h1 class="extra__header__main extra__header__store__main white-text">
                    Исследования <br>
                    <span class="orange">БРЕНДА</span>
                </h1>
				 <?php
                $main_descr = get_field('main-descr');
                if ($main_descr) {
                ?>
                <p class="extra__header__descr extra__header__brand__descr white-text">
    ...
    <div class="extra__checkbox-wrapper">
        ...
        <section class="extra__methods">
            <h2 class="extra__methods__header">
                <span class="orange">МЕТОДЫ</span> исследования бренда
            </h2>

            <ul class="extra__methods__list extra__methods__list__researchMarket research-brand-icon-container">
                <li class="extra__methods__item">
                    <img src="https://brandmetrika.ru/wp-content/uploads/2023/09/smartphone-icon.svg" alt="tel-survey">
        ...
        <section class="extra__grade">
            <h2 class="extra__grade__header">Что дает <span class="orange">ИССЛЕДОВАНИЕ</span> бренда?</h2>
